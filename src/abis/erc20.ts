export const erc20 = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'newGasDistri', type: 'uint256' }],
    name: 'changeGasDistribution',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  { inputs: [], name: 'publicDistributeRewards', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
