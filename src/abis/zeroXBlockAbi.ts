export const zeroXBlockAbi = [
  ...
  {
    inputs: [
      { internalType: 'bool', name: 'is0xBOut', type: 'bool' },
  ...
  {
    inputs: [{ internalType: 'enum ContType', name: '__cType', type: 'uint8' }],
  ...
  {
    inputs: [{ internalType: 'address', name: 'liqRouter', type: 'address' }],
